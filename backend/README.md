...
## Project Structure
    ...
    ├── testapiautoconnect_115073  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115073`
...
2. Clone this repo and `cd testapiautoconnect_115073`
